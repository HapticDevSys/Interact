...
local function createOption(coords, option, id, width, showDot, alpha)
    utils.drawOption(coords, option.label, 'karmainteractions_txd', currentSelection == id and selected or unselected, id - 1, width, showDot, alpha)
end
        ...
        if interaction then
            ...
            if GetScreenCoordFromWorldCoord(coords.x, coords.y, coords.z) then
                ...
                if isPrimary and currentAlpha < 0 then
                    ...
                    DrawSprite('karmainteractions_txd', interact, 0, 0, 0.0185, 0.03333333333333333, 0, 255, 255, 255, alpha)
                    ResetScriptGfxAlign()
                    ...
                    DrawSprite('karmainteractions_txd', pin, 0, 0, 0.0127, 0.025, 0, 255, 255, 255, isPrimary and currentAlpha or 255)
                end
...
CreateThread(function ()
    lib.requestStreamedTextureDict('karmainteractions_txd')
    while true do
        local wait = 500
